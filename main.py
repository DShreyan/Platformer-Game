...
def get_username():
    ...
    image_pil = Image.open("./assets/Background/frontpage3.jpg")
    background_image = ImageTk.PhotoImage(image_pil)
    background_label = tk.Label(dialog, image=background_image)
    background_label.place(x=0, y=0, relwidth=1, relheight=1)  
    background_label.image = background_image
    label = ttk.Label(dialog, text="Enter your username:", font=("Arial", 14), background="white")  
    label.pack(pady=20)  
    entry = ttk.Entry(dialog, font=("Arial", 12), width=30)  
    entry.pack(pady=10) 
    username = None
    def submit():
        nonlocal username  
...
def display_info(window):
    ...
    window.blit(timer_text, (WIDTH - 250, 20))  
    score_text = score_font.render("Score: " + str(score), True, (255, 0, 255))  
    window.blit(score_text, (WIDTH - 250, 70)) 
...
def draw_leaderboard(window):
    ...
    draw_text("Leaderboard", "./assets/fonts/roasting.ttf", (255, 0, 0), window, WIDTH // 2 - 130, 20, font_size=40)
    draw_text("Platform 1", "./assets/fonts/roasting.ttf", (255, 25,25), window, 20, 80, font_size=35)
    draw_text("Rank                         Player                                 Score                  Time", "./assets/fonts/roasting.ttf", (0,255,0), window, 50, 120, font_size=25)
    y_offset = 160
    for i, (player, score, time) in enumerate(platform1_scores[:5]):
        draw_text(f"{i+1}.", "./assets/fonts/roasting.ttf", (255, 255, 255), window, 85, y_offset, font_size=25)
        draw_text(player[:10] if len(player) > 10 else player, "./assets/fonts/roasting.ttf", (255, 255, 255), window, 290, y_offset, font_size=25)
        draw_text(str(score), "./assets/fonts/roasting.ttf", (255, 255, 255), window, 610, y_offset, font_size=25)
        draw_text(f"{time}s", "./assets/fonts/roasting.ttf", (255, 255, 255), window, 780, y_offset, font_size=25)
        y_offset += 40
    draw_text("Platform 2", "./assets/fonts/roasting.ttf", (255,25,25), window, 20, y_offset + 20, font_size=35)
    draw_text("Rank                         Player                                 Score                  Time", "./assets/fonts/roasting.ttf", (0, 255, 0), window, 50, y_offset + 60, font_size=25)
    y_offset += 100
    for i, (player, score, time) in enumerate(platform2_scores[:5]):
        draw_text(f"{i+1}.", "./assets/fonts/roasting.ttf", (255, 255, 255), window, 80, y_offset, font_size=25)
        draw_text(player[:10] if len(player) > 10 else player, "./assets/fonts/roasting.ttf", (255, 255, 255), window, 290, y_offset, font_size=25)
        draw_text(str(score), "./assets/fonts/roasting.ttf", (255, 255, 255), window, 610, y_offset, font_size=25)
        draw_text(f"{time}s", "./assets/fonts/roasting.ttf", (255, 255, 255), window, 780, y_offset, font_size=25)
        y_offset += 40
    draw_text("Back", "./assets/fonts/roasting.ttf", (255, 255, 255), window, WIDTH - 100, HEIGHT - 50, font_size=25)
    pygame.display.update()
